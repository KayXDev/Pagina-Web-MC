        ...
        <AnimatedSection>
          <Card className="max-w-4xl mx-auto">
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">2. Normas de Conducta</h2>
              <p className="text-gray-400 mb-6">
                Los usuarios deben seguir las normas del servidor. El incumplimiento puede resultar en baneos temporales o permanentes.
              </p>

              <h2 className="text-2xl font-bold text-white mb-4">3. Compras y Reembolsos</h2>
              <p className="text-gray-400 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">4. Privacidad</h2>
              <p className="text-gray-400 mb-6">
